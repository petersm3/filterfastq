...
* <code>filterfastq.pl</code> uses NCBI's command-line [BLAST](https://blast.ncbi.nlm.nih.gov/doc/blast-help/index.html) (<code>blastn</code>) to compare sequences in a semi-serial fashion, i.e., sets of 4 million sequences at a time, using multiple <code>blastn</code> threads, against the reference genome (as a BLAST database), which can take a long time
